/**
 * "Fruit-juice" package is a simple dependency injection library.
 *  Guice is a sophisticated and very feature rich library and at the same time complicated to use.
 *
 *  The basic idea of "Fruit-juice" is to provide a dependency injection functions based on values (configurations) given
 *  by annotations attached to a field to be injected.
 *
